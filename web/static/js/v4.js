...
function init() {
    ...
    relatedImg.innerHTML = `<img class="bar rec" id="graph1" src="/img/version4/graph1_bar_main_1.png">
                            <img class="bar rec" id="graph2" src="/img/version4/graph2_bar_main_1.png">
                            <img class="line rec"  id="graph3" src="/img/version4/graph3_line_main_1.png">`;
...
function renderRelated(id, graph) {
    document.querySelector("#specified").innerHTML = `<img class="${id}" src="/img/version4/${graph}_${id}_main.png" width=100% height=100%>`;
    document.querySelector("#cate_img").innerHTML = `<img src="/img/version4/${graph}_${id}_category.png" width="100%">`;
    document.querySelector("#quant_img").innerHTML = `<img src="/img/version4/${graph}_${id}_quant.png" width="100%">`;
}
